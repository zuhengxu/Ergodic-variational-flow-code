...
#1	0.2	20	0.2	10	0.06622467635571341	20.296194078	0.0
#2	0.2	20	0.2	10	0.060399061276145014	20.312363662	0.0
#3	0.2	20	0.2	10	0.05938190299030083	20.347126523	0.0
...
hline!([-0.36], linestyle= :dash,  label= "MixFlow", lw =3, legend = :topright, legendfontsize = 15)
