...
function hist(T,folder,name, kwargs...)
    p = vis_hist([-6: 0.1:5.1 ;], logp, T, label = "Mixture", lw = 3, legendfontsize=20, xtickfontsize=20, ytickfontsize=20, titlefontsize=20, guidefontsize=20)
...
hist(T_sample[:, 1], folder, "mix_sample_hist.png")
...
# E = ErgFlow.numerical_error_cheking(Flow, λ, xs, ys, 500)
...
# )
Ds = ErgFlow.density_evaluation(Flow, λ, xs, ys, n_mcmc)
