...
function running_convergence(o::HamFlow, a::HF_params; 
                            nsamples::Int64 = 50000, n_mcmc::Int64 = 2500, n_trials::Int64 = 10)
...
μ, D = MF["μ"], MF["D"]
a = ErgFlow.HF_params(0.008*ones(d), μ, D)
...
p1 = plot(ts, time_mean(m_iid', iters'), ribbon = time_std(m_iid', iters'),lw = 4, label = "iid", xticks = [0:10000:nsample ;])
    ...
    plot!(title = "Neal's Funnel", xlabel = "#Refreshments", ylabel = "")
...
savefig(p1, "figure/funnel_var_compare.png")
