...
p1 = #plot(iters, vec(median(m_hmc[1:n_stop, d1, :]'; dims =1)), ribbon = get_percentiles(m_hmc[1:n_stop, d1, :]), lw = 3,label = "HMC", legend = :bottomleft)
    # plot(iters, vec(median(m_erg[1:n_stop, d1, :]'; dims =1)), ribbon = get_percentiles(m_erg[1:n_stop, d1, :]), lw = 3,label = "MixFlow", xrotation = 20, legend = :bottomleft)
    plot(iters, vec(median(m_erg_single[1:n_stop, d1, :]'; dims =1)), ribbon = get_percentiles(m_erg_single[1:n_stop, d1, :]), lw = 3,label = "MixFlow-S", legend = :none)
...
p2 = #plot(iters, vec(median(m_hmc[1:n_stop, d2, :]'; dims =1)), ribbon = get_percentiles(m_hmc[1:n_stop, d2, :]), lw = 3,label = "HMC", legend = :none)
    # plot(iters, vec(median(m_erg[1:n_stop, d2, :]'; dims =1)), ribbon = get_percentiles(m_erg[1:n_stop, d2, :]), lw = 3,label = "MixFlow", xrotation = 20, legend = :none)
    plot(iters, vec(median(m_erg_single[1:n_stop, d2, :]'; dims =1)), ribbon = get_percentiles(m_erg_single[1:n_stop, d2, :]), lw = 3,label = "MixFlow-S", legend = :bottomright)
...
p = plot(p1, p2, layout = (1, 2), title = "sp_big")
savefig(p, "figure/spb_mean_est.png")
p1 = #plot(iters, vec(median(v_hmc[1:n_stop, d1, :]'; dims =1)), ribbon = get_percentiles(v_hmc[1:n_stop, d1, :]), lw = 3,label = "HMC", legend = :bottomright)
    #plot(iters, vec(median(v_erg[1:n_stop, d1, :]'; dims =1)), ribbon = get_percentiles(v_erg[1:n_stop, d1, :]), lw = 3,label = "MixFlow", xrotation = 20, legend = :bottomright)
    plot(iters, vec(median(v_erg_single[1:n_stop, d1, :]'; dims =1)), ribbon = get_percentiles(v_erg_single[1:n_stop, d1, :]), lw = 3,label = "MixFlow-S", legend = :none)
...
p2 = #plot(iters, vec(median(v_hmc[1:n_stop, d2, :]'; dims =1)), ribbon = get_percentiles(v_hmc[1:n_stop, d2, :]), lw = 3,label = "HMC", legend = :none)
    # plot(iters, vec(median(v_erg[1:n_stop, d2, :]'; dims =1)), ribbon = get_percentiles(v_erg[1:n_stop, d2, :]), lw = 3,label = "MixFlow", xrotation = 20, legend = :none)
    plot(iters, vec(median(v_erg_single[1:n_stop, d2, :]'; dims =1)), ribbon = get_percentiles(v_erg_single[1:n_stop, d2, :]), lw = 3,label = "MixFlow-S", legend = :bottomright)
...
p = plot(p1, p2, layout = (1, 2), title = "sp_big")
savefig(p, "figure/spb_var_est.png")