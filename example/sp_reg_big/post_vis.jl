...
μ,D = ps1[1][1], ps1[1][2]
el_svi = SVI.ELBO(o1, μ,D; elbo_size = 10000) # 403
...
single_nf(logp_nf, logq_nf, μ, D, d; niter = 200000, hdims =20, nlayers = 5, elbo_size = 10, nelbo_est = 10000, flow_type = "RealNVP", seed = 1)
