...
# tune_nf(logp_nf, logq_nf, μ, D, d; nlayers = [5], hdims = 20, flow_type="RealNVP", nrun = 5, file_name = "RealNVP5_run.jld")
# tune_nf(logp_nf, logq_nf, μ, D, d; nlayers = [8], hdims = 20, flow_type="RealNVP", nrun = 5, file_name = "RealNVP8_run.jld")
...
###################
files = ["RealNVP5.jld","Planar5.jld", "Radial20.jld"]
nf_ksd(files, o)