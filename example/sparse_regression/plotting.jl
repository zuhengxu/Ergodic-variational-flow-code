...
hline!([1.26], linestyle=:dash, lw = 5, label = "NEO", color = colours[end-1])
...
p = plot(p1, p2, layout = (1, 2), title = "Sparse Regression")
savefig(p, "figure/sp_reg_mean_est.png")
...
p = plot(p1, p2, layout = (1, 2), title = "Sparse Regression")
savefig(p, "figure/sp_reg_var_est.png")