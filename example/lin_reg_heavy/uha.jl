...
if size(ARGS,1) > 0
    JLD.save("uha_lin_reg_heavy_"*string(pair)*".jld", "PS", PS[1], "elbo", El_uha, "ksd", Ksd_uha, "time", t)
else
    JLD.save("uha_lin_reg_heavy.jld", "PS", PS[1], "elbo", El_uha, "ksd", Ksd_uha, "time", t)
end
