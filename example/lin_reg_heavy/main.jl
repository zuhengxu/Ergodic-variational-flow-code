...
Random.seed!(1)
ELBO_plot(o, o1; μ=μ, D = D, eps = [2e-5, 2.5e-5, 3e-5, 5e-5], Ns = [100, 200, 500, 1000, 1500, 2000, 2500], nBs = [0,0,0,0,0,0,0], elbo_size = 1000, 
        res_name = "el.jld",fig_name = "lrh_elbo.png", title = "Linear regression (heavy)", 
        xtickfont=font(18), ytickfont=font(18), guidefont=font(18), legendfont=font(18), titlefontsize = 18, xrotation = 20)

# ELBO_plot(o, o1; μ=μ, D = D, eps = [2.5e-5, 5e-5, 1e-4], Ns = [200, 800, 1500, 2000, 2500], nBs = [0,0,0,0,0,0,0], elbo_size = 1000, 
#         res_name = "el1.jld",fig_name = "lrh_elbo1.png", title = "Linear regression (heavy)", 
#         xtickfont=font(18), ytickfont=font(18), guidefont=font(18), legendfont=font(18), titlefontsize = 18, xrotation = 20)
...
# Random.seed!(1)
# ksd_plot(o; μ = μ, D = D, ϵ = 2.5e-5*ones(d), Ns = [100, 200, 500, 1000, 1500, 2000, 2500], nBs = [0], nsample = 5000, title  = "Linear regression (heavy)", fig_name = "ksd.png", res_name = "ksd.jld")
